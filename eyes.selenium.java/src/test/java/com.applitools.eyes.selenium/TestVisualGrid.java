...
public final class TestVisualGrid {
...
//        try {
        ...
        eyes.open(driver, "Visual Grid Test", "This is a Smurf's test",
                new RectangleSize(800, 600));

        // Navigate the browser to the "hello world!" web-site.
        driver.get("http://applitools.github.io/demo/TestPages/VisualGridTestPage/");
        ...
        String sourceJsonAsString = GeneralUtils.readToEnd(TestVisualGrid.class.getResourceAsStream("/domcapture.json"));
