...
function __captureDomIE() {
  var captureDomIE = (function () {
            'use strict';
            ...
            if (global$1._babelPolyfill && typeof console !== "undefined" && console.warn) {
              console.warn("@babel/polyfill is loaded more than once on this page. This is probably not desirable/intended " + "and may have consequences if different versions of the polyfills are applied sequentially. " + "If you do need to load the polyfill more than once, use @babel/polyfill/noConflict " + "instead to bypass the warning.");
            }

            global$1._babelPolyfill = true;
            ...
            function _getImageSizes() {
              _getImageSizes = asyncToGenerator(
              /*#__PURE__*/
            ...
            function makeGetBundledCssFromCssText(_ref) {
              ...
              return (
                /*#__PURE__*/
                function () {
                  var _getBundledCssFromCssText = asyncToGenerator(
                  /*#__PURE__*/
                  regenerator.mark(function _callee(cssText, resourceUrl) {
                    var unfetchedResources, bundledCss, styleSheet, _arr, _i, rule, nestedUrl, nestedResource, _ref2, nestedCssText, nestedUnfetchedResources;
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            _arr = Array.from(styleSheet.cssRules);
                            _i = 0;
            ...
            function makeFetchCss(fetch) {
              return (
                /*#__PURE__*/
                function () {
                  var _fetchCss = asyncToGenerator(
                  /*#__PURE__*/
            ...
            function makeExtractCssFromNode(_ref) {
              ...
              return (
                /*#__PURE__*/
                function () {
                  var _extractCssFromNode = asyncToGenerator(
                  /*#__PURE__*/
                  regenerator.mark(function _callee(node, baseUrl) {
            ...
            function makeCaptureNodeCss(_ref) {
              ...
              return (
                /*#__PURE__*/
                function () {
                  var _captureNodeCss = asyncToGenerator(
                  /*#__PURE__*/
                  regenerator.mark(function _callee(node, baseUrl) {
            ...
            function _captureFrame() {
              _captureFrame = asyncToGenerator(
              /*#__PURE__*/
                ...
                return regenerator.wrap(function _callee5$(_context5) {
                  while (1) {
                    switch (_context5.prev = _context5.next) {
                      case 0:
                        _doCaptureFrame = function _ref13() {
                          _doCaptureFrame = asyncToGenerator(
                          /*#__PURE__*/
                          regenerator.mark(function _callee4(frameDoc) {
                            ...
                            return regenerator.wrap(function _callee4$(_context4) {
                              while (1) {
                                switch (_context4.prev = _context4.next) {
                                  case 0:
                                    _iframeToJSON = function _ref8() {
                                      _iframeToJSON = asyncToGenerator(
                                      /*#__PURE__*/
                                      regenerator.mark(function _callee3(el) {
                                        var obj, xpath;
                                          ...
                                          while (1) {
                                            switch (_context3.prev = _context3.next) {
                                              ...
                                              case 16:
                                                ...
                                                console.log('error in iframeToJSON', _context3.t1);
                                    ...
                                    iframeToJSON = function _ref7(_x4) {
                                      return _iframeToJSON.apply(this, arguments);
                                    };

                                    _elementToJSON = function _ref6() {
                                      _elementToJSON = asyncToGenerator(
                                      /*#__PURE__*/
                                      regenerator.mark(function _callee2(el) {
                                    ...
                                    elementToJSON = function _ref5(_x3) {
                                      return _elementToJSON.apply(this, arguments);
                                    };

                                    _captureNode = function _ref4() {
                                      _captureNode = asyncToGenerator(
                                      /*#__PURE__*/
                                    ...
                                    captureNode = function _ref3(_x2) {
                                      return _captureNode.apply(this, arguments);
                                    };
                        ...
                        doCaptureFrame = function _ref12(_x) {
                          return _doCaptureFrame.apply(this, arguments);
                        };

                        captureTextNode = function _ref11(node) {
                          return {
                            tagName: '#text',
                        ...
                        notEmptyObj = function _ref10(obj) {
                          return Object.keys(obj).length ? obj : undefined;
                        };

                        filter = function _ref9(x) {
                          return !!x;
                        };
                      ...
                      case 19:
                        ...
                        console.log('[captureFrame]', Date.now() - start); // Polyfill :
  ...
  return captureDomIE.apply(this, arguments);
}