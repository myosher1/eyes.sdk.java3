...
public class Eyes implements IRenderingEyes {
    ...
    public void check(ICheckRGSettings settings) {
        ...
        logger.log(" $$$$$$$$$$    Dom extraction starting   (" + settings.toString() + ")   $$$$$$$$$$$$");
        String scriptResult = (String) this.jsExecutor.executeAsyncScript(domCaptureScript);

        logger.log(" $$$$$$$$$$    Dom extracted  (" + settings.toString() + ")   $$$$$$$$$$$$");
        ...
        logger.log(" $$$$$$$$$$    added check tasks  (" + settings.toString() + ")   $$$$$$$$$$$$");
        ...
        logger.log(" $$$$$$$$$$    created renderTask  (" + settings.toString() + ")   $$$$$$$$$$$$");
    }
